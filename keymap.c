...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		//base layer QWERTY
    [0] = LAYOUT_split_3x6_3(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_ESC, KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_ENT, TT(1), KC_SPC, KC_BSPC, KC_RGUI, KC_RALT, KC_ENT),
		//Common symbols/numbers/arrows
    [1] = LAYOUT_split_3x6_3(KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_P7, KC_P8, KC_P9, KC_PMNS, KC_PAST, KC_PSLS, KC_TRNS, KC_GRV, KC_AMPR, KC_BSLS, KC_LCBR, KC_RCBR, KC_P4, KC_P5, KC_P6, KC_PPLS, KC_UP, KC_PEQL, TT(2), TT(3), KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_P1, KC_P2, KC_P3, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_UNDS, KC_TRNS, KC_SCLN, KC_P0, KC_PDOT),
